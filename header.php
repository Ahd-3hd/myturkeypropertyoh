        ...
        <form action="<?php echo the_permalink();?>/properties" method="get">
          <div class="input-group">
            ...
            <select name="location" class="form-control form-control-sm">
              ...
              <option value="antalia"
                <?php selected( isset($_GET['location']) ? $_GET['location'] : '', 'antalia' ); ?>>
                Antalia</option>
              <option value="bursa" <?php selected( isset($_GET['location']) ? $_GET['location'] : '', 'bursa' ); ?>>
                Bursa
              </option>
              <option value="fethiye"
                <?php selected( isset($_GET['location']) ? $_GET['location'] : '', 'fethiye' ); ?>>
                Fethiye
              </option>
